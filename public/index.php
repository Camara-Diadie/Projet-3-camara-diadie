...
<body>
    ...
    <section id="presentation">
        ...
        <img class="ilustration" src="img/ilustration.jpg" alt="">
    </section >
    ...
    <section id="info-acteur">
        ...
        <div id="text-acteur"> 
            <div class="acteur">
                <img class="logo-acteur" src="img/CDE.png" alt="logo">
            ...
            <div class="acteur">
                <img class="logo-acteur" src="img/protectpeople.png" alt="logo">
                <div class="presentation-entreprise">
                    <h3 class="info" >Protectpeople finance la solidarité nationale. Nous appliquons le principe édifié par ...</h3>
                    <a class="lien" href="acteur-protectpeople.php?info='.' '.$_SESSION['nom'].'  '.$_SESSION['prenom']);" class="lien">lire la suite</a>
                </div>
            </div>
        </div>
    </section>
